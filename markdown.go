...
var (
	markdownsivunAlku  = []byte(`<!DOCTYPE html><head><meta charset="utf-8"><link rel="stylesheet" type="text/css" href="/home/joonazan/ohjelmointiohjeet/static/ohje.css"></head><body>`)
